...
读取 [项目模型](../_shared/project-model.md)、[路径规则](../_shared/path-and-reference-rules.md)、[Work contract](references/work-contract.md)、目标 workflow 的 `INDEX.md`、`common/rules`、相关 schema/tools、`_state` 种子、相邻 works 和真实调用方。
