...
### Tests
- Added `learning-g-goal-mine-pass` coverage for mine_unit_cap, 10Q/b03, split-proposal, interleave, budget reset, split depth=2, and learner-protocol fields in probes.
